MODULE Module1
    ...
    PROC TakeBlackLeft()
        MoveJ BlackLeft_1,vmax,fine,MoldGripper\WObj:=MoldsStore;
        MoveL BlackLeft_2,vmax,fine,MoldGripper\WObj:=MoldsStore;
        MoveL BlackLeft_Goal,vmax,fine,MoldGripper\WObj:=MoldsStore;
        MoveL BlackLeft_3,vmax,z100,MoldGripper\WObj:=MoldsStore;
    ENDPROC
    PROC main()
        GoHome;
        CycleBlack;
    ...
    ENDPROC
    PROC GoHome()
        MoveJ RepPointL_Down,v7000,z200,MoldGripper\WObj:=LeftBase;
    ENDPROC
    PROC LetBaseLeft()
        MoveL RepPointL_Up,vmax,fine,MoldGripper\WObj:=LeftBase;
        MoveL BaseL_1,vmax,fine,MoldGripper\WObj:=LeftBase;
        MoveL LeftGoal,vmax,fine,MoldGripper\WObj:=LeftBase;
        MoveL BaseL_2,vmax,fine,MoldGripper\WObj:=LeftBase;
        MoveL RepPointL_Down,v7000,fine,MoldGripper\WObj:=LeftBase;
    ENDPROC
    PROC LetBaseRight()
        MoveJ RepPointR_Up,vmax,fine,MoldGripper\WObj:=RightBase;
        MoveL BaseR_1,vmax,fine,MoldGripper\WObj:=RightBase;
        MoveL RightGoal,vmax,fine,MoldGripper\WObj:=RightBase;
        MoveL BaseR_2,vmax,fine,MoldGripper\WObj:=RightBase;
        MoveL RepPointR_Down,v7000,fine,MoldGripper\WObj:=RightBase;
    ENDPROC
    PROC TakeBlackRight()
        MoveJ BlackRight_1,vmax,fine,MoldGripper\WObj:=MoldsStore;
        MoveL BlackRight_2,vmax,fine,MoldGripper\WObj:=MoldsStore;
        MoveL BlackRight_Goal,vmax,fine,MoldGripper\WObj:=MoldsStore;
        MoveL BlackRight_3,vmax,z100,MoldGripper\WObj:=MoldsStore;
    ENDPROC
    PROC TakeRedLeft()
        MoveJ RedLeft_1,vmax,fine,MoldGripper\WObj:=MoldsStore;
        MoveL RedLeft_2,vmax,fine,MoldGripper\WObj:=MoldsStore;
        MoveL RedLeft_Goal,vmax,fine,MoldGripper\WObj:=MoldsStore;
        MoveL RedLeft_3,vmax,z100,MoldGripper\WObj:=MoldsStore;
    ENDPROC
    PROC TakeRedRight()
        MoveJ RedRight_1,vmax,fine,MoldGripper\WObj:=MoldsStore;
        MoveL RedRight_2,vmax,fine,MoldGripper\WObj:=MoldsStore;
        MoveL RedRight_Goal,vmax,fine,MoldGripper\WObj:=MoldsStore;
        MoveL RedRight_3,vmax,z100,MoldGripper\WObj:=MoldsStore;
    ENDPROC
    PROC TakeBlueLeft()
        MoveJ BlueLeft_1,vmax,fine,MoldGripper\WObj:=MoldsStore;
        MoveL BlueLeft_2,vmax,fine,MoldGripper\WObj:=MoldsStore;
        MoveL BlueLeft_Goal,vmax,fine,MoldGripper\WObj:=MoldsStore;
        MoveL BlueLeft_3,vmax,z100,MoldGripper\WObj:=MoldsStore;
    ENDPROC
    PROC TakeBlueRight()
        MoveJ BlueRight_1,vmax,fine,MoldGripper\WObj:=MoldsStore;
        MoveL BlueRight_2,vmax,fine,MoldGripper\WObj:=MoldsStore;
        MoveL BlueRight_Goal,vmax,fine,MoldGripper\WObj:=MoldsStore;
        MoveL BlueRight_3,vmax,z100,MoldGripper\WObj:=MoldsStore;
    ENDPROC
    PROC TakeBaseLeft()
        MoveL RepPointL_Down,v7000,fine,MoldGripper\WObj:=LeftBase;
        MoveL BaseL_2,vmax,fine,MoldGripper\WObj:=LeftBase;
    ...
    ENDPROC
    PROC TakeBaseRight()
        MoveJ RepPointR_Down,v7000,fine,MoldGripper\WObj:=RightBase;
        MoveL BaseR_2,vmax,fine,MoldGripper\WObj:=RightBase;
        MoveL RightGoal,vmax,fine,MoldGripper\WObj:=RightBase;
        MoveL BaseR_1,vmax,fine,MoldGripper\WObj:=RightBase;
        MoveL RepPointR_Up,vmax,fine,MoldGripper\WObj:=RightBase;
    ENDPROC
    PROC LetBlackLeft()
        TakeBlackLeft;
        LetBaseLeft;
    ...
    PROC ReturnBlackLeft()
        MoveJ BlackLeft_3,vmax,z100,MoldGripper\WObj:=MoldsStore;
        MoveL BlackLeft_Goal,vmax,fine,MoldGripper\WObj:=MoldsStore;
        MoveL BlackLeft_2,vmax,fine,MoldGripper\WObj:=MoldsStore;
        MoveL BlackLeft_1,vmax,fine,MoldGripper\WObj:=MoldsStore;
    ENDPROC
    PROC ReturnBlackRight()
        MoveJ BlackRight_3,vmax,z100,MoldGripper\WObj:=MoldsStore;
        MoveL BlackRight_Goal,vmax,fine,MoldGripper\WObj:=MoldsStore;
        MoveL BlackRight_2,vmax,fine,MoldGripper\WObj:=MoldsStore;
        MoveL BlackRight_1,vmax,fine,MoldGripper\WObj:=MoldsStore;
    ENDPROC
    PROC ReturnRedLeft()
        MoveJ RedLeft_3,vmax,z100,MoldGripper\WObj:=MoldsStore;
        MoveL RedLeft_Goal,vmax,fine,MoldGripper\WObj:=MoldsStore;
        MoveL RedLeft_2,vmax,fine,MoldGripper\WObj:=MoldsStore;
        MoveL RedLeft_1,vmax,fine,MoldGripper\WObj:=MoldsStore;
    ENDPROC
    PROC ReturnRedRight()
        MoveJ RedRight_3,vmax,z100,MoldGripper\WObj:=MoldsStore;
        MoveL RedRight_Goal,vmax,fine,MoldGripper\WObj:=MoldsStore;
        MoveL RedRight_2,vmax,fine,MoldGripper\WObj:=MoldsStore;
        MoveL RedRight_1,vmax,fine,MoldGripper\WObj:=MoldsStore;
    ENDPROC
    PROC ReturnBlueLeft()
        MoveJ BlueLeft_3,vmax,z100,MoldGripper\WObj:=MoldsStore;
        MoveL BlueLeft_Goal,vmax,fine,MoldGripper\WObj:=MoldsStore;
        MoveL BlueLeft_2,vmax,fine,MoldGripper\WObj:=MoldsStore;
        MoveL BlueLeft_1,vmax,fine,MoldGripper\WObj:=MoldsStore;
    ENDPROC
    PROC ReturnBlueRight()
        MoveJ BlueRight_3,vmax,z100,MoldGripper\WObj:=MoldsStore;
        MoveL BlueRight_Goal,vmax,fine,MoldGripper\WObj:=MoldsStore;
        MoveL BlueRight_2,vmax,fine,MoldGripper\WObj:=MoldsStore;
        MoveL BlueRight_1,vmax,fine,MoldGripper\WObj:=MoldsStore;
    ENDPROC
    PROC BackBlackLeft()
        TakeBaseLeft;
        ReturnBlackLeft;
